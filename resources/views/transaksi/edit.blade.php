          ...
          <div class="col-sm-6">
            <div class="form-group mb-3">
              ...
              <select class="form-control @error('id_pembeli') is-invalid @enderror" name="id_pembeli" id="id_pembeli">
                ...
                <option value="{{ $pembeli->id }}" {{ $transaksi->id_pembeli == $pembeli->id ? 'selected' : ''}}>{{ $pembeli->nama }}</option>
                @endforeach
              </select>
              @error('id_pembeli')
            ...
            <div class="form-group mb-3">
              ...
              <select class="form-control @error('id_obat') is-invalid @enderror" name="id_obat" id="id_obat">
                ...
                <option value="{{ $obat->id }}" {{ $transaksi->id_obat == $obat->id ? 'selected' : ''}}>{{ $obat->nama }}</option>
                @endforeach
              </select>
              @error('id_obat')
              <div class="invalid-feedback">
            ...
            <div class="form-group mb-3">
              ...
              <input type="text" class="form-control @error('tanggal') is-invalid @enderror" name="tanggal" id="tanggal" value="{{ $transaksi->tanggal }}" placeholder="Tanggal">
              @error('tanggal')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
            ...
            <div class="form-group mb-3">
              ...
              <input type="text" class="form-control @error('keterangan') is-invalid @enderror" name="keterangan" id="keterangan" value="{{ $transaksi->keterangan }}" placeholder="Keterangan">
              @error('keterangan')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
